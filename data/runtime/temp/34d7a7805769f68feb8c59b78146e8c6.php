<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"./application/admin/template/archives\batch_copy.htm";i:1594086333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form class="form-horizontal" id="post_form" method="POST" action="<?php echo (isset($form_action) && ($form_action !== '')?$form_action:''); ?>" onsubmit="check_submit();">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <input type="text" name="num" value="5" class="input" onkeyup="this.value=this.value.replace(/[^\d]/g,'');" onpaste="this.value=this.value.replace(/[^\d]/g,'');">
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
