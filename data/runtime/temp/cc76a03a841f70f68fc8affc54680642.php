<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"./application/admin/template/product\attribute_edit.htm";i:1594086341;s:92:"D:\www\web\bjms123_H4yI1YT2aGkYNC2RN6tm\wwwroot\application\admin\template\public\layout.htm";i:1594086342;s:92:"D:\www\web\bjms123_H4yI1YT2aGkYNC2RN6tm\wwwroot\application\admin\template\public\footer.htm";i:1594086342;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="box-shadow:none;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo U('Product/attribute_edit'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <label><input type="radio" value="0" name="attr_input_type" <?php if(empty($field['attr_input_type']) || (($field['attr_input_type'] instanceof \think\Collection || $field['attr_input_type'] instanceof \think\Paginator ) && $field['attr_input_type']->isEmpty())): ?>checked="checked"<?php endif; ?> />单行文本</label>
...
<script type="text/javascript">
    ...
    */
    function check_submit(form_id)
    {
        ...
        $.ajax({
            type : "POST",
            url  : "<?php echo url('Product/attribute_edit', ['_ajax'=>1]); ?>",
