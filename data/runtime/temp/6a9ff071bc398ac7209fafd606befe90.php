<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"./template/default/pc/view_product_x.htm";i:1594189021;s:78:"D:\www\web\bjms123_H4yI1YT2aGkYNC2RN6tm\wwwroot\template\default\pc\header.htm";i:1594086312;s:78:"D:\www\web\bjms123_H4yI1YT2aGkYNC2RN6tm\wwwroot\template\default\pc\footer.htm";i:1594178943;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
                  ...
                  <div class="product-detail-info-in">
                    <div class="prd_detInfo_con">
                      ...
                      <div class="product-grayBox clearfix">
                        ...
                        <?php echo isset($field["ey_1563185380"])?$field["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($field["ey_1563185376"]))?$field["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
						    <div style="position: absolute; top: 250px;"><img src="template/default/pc/skin/img/tel.png" alt="" ><span style="font-size: 24px;font-weight: 700;display: inline-block;margin-left: 20px;margin-right: 20px;">咨询热线：0917-8851555/8880006</span>
							<span  style="display: inline-block;background-color:  #f65607; text-align: center; width: 120px;height: 50px;border-radius: 5px;line-height: 50px;">
  						<a href="#" style="color: #fff;font-size: 16px; font-weight: 400;">在线咨询</a>
  						</span>
						</div>
                        </div>
        ...
        cursor:auto;
			...
			<ul style="list-style:none; margin-left: 15px;">
				...
				<li style="float: left;text-align: center;margin-left: 15px;">
					<a href="<?php echo $field['arcurl']; ?>"> <img src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" width="270px" height="190px" style="padding: 2px; background-color: #f65607;"><br> <span><?php echo $field['title']; ?></span></a> 
				</li>
