<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"./template/default/pc/index.htm";i:1594086312;s:78:"D:\www\web\bjms123_H4yI1YT2aGkYNC2RN6tm\wwwroot\template\default\pc\header.htm";i:1594086312;s:78:"D:\www\web\bjms123_H4yI1YT2aGkYNC2RN6tm\wwwroot\template\default\pc\footer.htm";i:1594178943;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<script>
  ...
  <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "3"; endif; if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 10; endif; $tagChannelartlist = new \think\template\taglib\eyou\TagChannelartlist; $_result = $tagChannelartlist->getChannelartlist($typeid, "self"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$channelartlist): $channelartlist["typename"] = text_msubstr($channelartlist["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $channelartlist;$i= intval($key) + 1;$mod = ($i % 2 ); ?>
   <!-- 自定义产品中心-->
   <section class=" text-xs-center" style="background-color:#f65607 ;width: 100%;padding: 30px 0;">
       <div class="container">
           <div class="col-lg-3 text-lg-center" style="color: #fff;">
  					<div class="pro-cont" >
  						...
  						<a href="<?php  $__VALUE__ = isset($channelartlist["typeurl"]) ? $channelartlist["typeurl"] : "变量名不存在"; echo $__VALUE__; ?>" style="color: #fff;">查看更多</a>
  						</span>			
  					</div>
           </div>
           <div class="col-lg-9 " style="padding: 28px;">
			  
  						<div class="pro-view col-xs-12" style="width: 24%;">
  							<div style="float: left;">
  								<div class="pro-tit">钛棒</div>
  							<span><a href="<?php echo $field['typeurl']; ?>"><查看更多></a></span>
  							</div>
  							<div style="float: right;">
  								<img src="template/default/pc/skin/img/001.png" alt="钛棒" >
  							</div>
  						</div>
						<div class="pro-view col-xs-12" style="width: 24%;">
							<div style="float: left;">
								<div class="pro-tit">钛板</div>
							<span><a href="<?php echo $field['typeurl']; ?>"><查看更多></a></span>
							</div>
							<div style="float: right;">
								<img src="template/default/pc/skin/img/002.png" alt="钛板" >
							</div>
						</div>
						<div class="pro-view col-xs-12" style="width: 24%;">
							<div style="float: left;">
								<div class="pro-tit">钛管</div>
							<span><a href="<?php echo $field['typeurl']; ?>"><查看更多></a></span>
							</div>
							<div style="float: right;">
								<img src="template/default/pc/skin/img/003.png" alt="钛管" >
							</div>
						</div>
						<div class="pro-view col-xs-12" style="width: 24%;">
							<div style="float: left;">
								<div class="pro-tit">钛丝</div>
							<span><a href="<?php echo $field['typeurl']; ?>"><查看更多></a></span>
							</div>
							<div style="float: right;">
								<img src="template/default/pc/skin/img/004.png" alt="钛丝" >
							</div>
						</div>
						<div>
					<div class="pro-view col-xs-12" style="width: 24%; margin-left:90px;">
						<div style="float: left;">
							<div class="pro-tit">钛锻件</div>
						<span><a href="<?php echo $field['typeurl']; ?>"><查看更多></a></span>
						</div>
						<div style="float: right;">
							<img src="template/default/pc/skin/img/005.png" alt="钛锻件" >
						</div>
					</div>
					<div class="pro-view col-xs-12" style="width: 24%;">
						<div style="float: left;">
							<div class="pro-tit">钛加工件</div>
						<span><a href="<?php echo $field['typeurl']; ?>"><查看更多></a></span>
						</div>
						<div style="float: right;">
							<img src="template/default/pc/skin/img/006.png" alt="钛加工件" >
						</div>
					</div>
					<div class="pro-view col-xs-12" style="width: 24%;">
						<div style="float: left;">
							<div class="pro-tit">钛标准件</div>
						<span><a href="<?php echo $field['typeurl']; ?>"><查看更多></a></span>
						</div>
						<div style="float: right;">
							<img src="template/default/pc/skin/img/007.png" alt="钛标准件" >
						</div>
					</div>
				</div>
                ...
                <div class="w-title-in">
                  <div class="w-title-inner">
                    <div class="title-h-in title-word">
                      <h1 class="color_main color_h">产品推荐</h1>
  ...
  'flag' => 'c',
		      ...
		      <li class="item" style="float: left;width: 294px;height: 285px;display: inline;margin: 0 0 0 4px;"> <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>" class="proimg"><img style="padding: 3px;background-color: #f65607;" src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" width="273" height="248" />
	                  ...
	                  <td class="td-w" width="50%"><div class="div-padding">
	                      ...
	                      <div class="li-div">
	                        <div class="not-animated w-button" data-animate="" style="padding-top:20px;">
	                          <div style="background-color: #f65607 ;border-radius: 5px;" class=" btn-default-w btn-large-w g-click-to-link" onclick="window.open('<?php  $__VALUE__ = isset($channelartlist["typeurl"]) ? $channelartlist["typeurl"] : "变量名不存在"; echo $__VALUE__; ?>','_self')"> <span class="btn-inner" style="color: #fff ;">查看更多</span> </div>
...
<div style=" height: auto; margin: 0px auto;">
	  ...
	  <div class="not-animated w-text" data-animate="" style="">
	    <div class="w-title w-title1">
	      <div class="w-title-in">
	        <div class="w-title-inner">
	          <div class="title-h-in">
	            <h1 class="color_main color_h">福泽优势</h1>
	            <!--<span class="color_vice color_span"><?php  $__VALUE__ = isset($channelartlist["seo_description"]) ? $channelartlist["seo_description"] : "变量名不存在"; echo $__VALUE__; ?></span>-->
	         <div class="title_line"></div>
	          <div class="title_eng">
	         		Fuze Advantage
    ...
    <img style="max-width:100%;" src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_6"); echo $__VALUE__; ?>" />
    </div>
    </div>
	<!--新闻资讯-->
	 <!-- 新闻资讯 start zhanghaijing20160623 --> 
	   <!--第五部分开始--> 
	   <div class="container  hidden-xs-down" style="margin-bottom: 60px; margin-top: 50px;">  
	   <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "2"; endif; if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 10; endif; $tagChannelartlist = new \think\template\taglib\eyou\TagChannelartlist; $_result = $tagChannelartlist->getChannelartlist($typeid, "self"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$channelartlist): $channelartlist["typename"] = text_msubstr($channelartlist["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $channelartlist;$i= intval($key) + 1;$mod = ($i % 2 ); ?>  
	    <section style="height: 500px;" class="chanpin " > 
	     <div class=" bodyha"> 
	      <div class=" bodyha bxywu"> 
	       <div class="bxywun"> 
	        ...
	        <div class="bxywu3"> 
	         <ul> 
	          ...
	          <li class="on" style="padding: 5px 10px;border:1px solid #f65607; width: 112px; text-align: center;cursor:pointer; "><?php echo $field['typename']; ?></li> 
	       ...
	       <li class="" style="padding: 5px 10px;border:1px solid #f65607; width: 112px; text-align: center;cursor:pointer; "><?php echo $field['typename']; ?></li>
	       <?php endif; else: echo htmlspecialchars_decode("");endif; $field = [];  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "12"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?>
	      <li class="" style="padding: 5px 10px;border:1px solid #f65607; width: 112px; text-align: center;cursor:pointer; "><?php echo $field['typename']; ?></li>
  ...
  'typeid' => '10',
  'infolen' => '60',
); $tagArclist = new \think\template\taglib\eyou\TagArclist; $_result = $tagArclist->getArclist($param, $row, "", "","desc","",$tag,"0","on","off");if(is_array($_result["list"]) || $_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = is_array($_result["list"]) ? array_slice($_result["list"],0, $row, true) : $_result["list"]->slice(0, $row, true);  $__TAG__ = $_result["tag"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 50, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 60, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
	           <div class="dd1"> 
	            <div class="dd11">
	             <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>" alt="<?php echo $field['title']; ?>"><img src="<?php echo $field['litpic']; ?>"></a>
	            </div> 
	            <div class="dd12">
	             <span><i><?php echo MyDate('d',$field['add_time']); ?></i><?php echo MyDate('Y-m',$field['add_time']); ?></span> 
	             <h1><a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>" alt="<?php echo $field['title']; ?>"><?php echo $field['title']; ?></a></h1> 
	            </div> 
	            <div class="dd13">
					<?php echo html_msubstr($field['seo_description'],0,40,true); ?>...
	            </div> 
	           </div> 
			     	<?php ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
	           <div class="dd2"> 
  ...
  'typeid' => '10',
  'infolen' => '60',
); $tagArclist = new \think\template\taglib\eyou\TagArclist; $_result = $tagArclist->getArclist($param, $row, "", "","desc","",$tag,"0","on","off");if(is_array($_result["list"]) || $_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = is_array($_result["list"]) ? array_slice($_result["list"],1, $row, true) : $_result["list"]->slice(1, $row, true);  $__TAG__ = $_result["tag"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 20, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 60, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?> 
				<span><a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>" alt="<?php echo $field['title']; ?>"><i><b> <?php echo MyDate('d',$field['add_time']); ?></b> <?php echo MyDate('Y-m',$field['add_time']); ?></i><strong><?php echo $field['title']; ?></strong><em> <?php echo html_msubstr($field['seo_description'],0,55,true); ?>...</em></a></span> 
				<?php ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
				  </p> 
	           </div> 
  ...
  'infolen' => '60',
	           ...
	           <div class="dd1">
	            ...
	            <div class="dd13">
	           				<?php echo html_msubstr($field['seo_description'],0,50,true); ?>...
	            </div> 
	           </div> 
	             	<?php ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
	           <div class="dd2"> 
